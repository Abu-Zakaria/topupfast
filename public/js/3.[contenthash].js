                      ...
                      _vm._l(_vm.orders.data, function(row, index) {
                        return _c("tr", { key: index }, [
                          ...
                          row.status == "pending"
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.isOrderAccepted(row) && row.status != "pending"
                            ? _c("td", { attrs: { width: "200" } }, [
