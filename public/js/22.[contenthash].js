...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    checkChange: function checkChange() {
      var trs = document.getElementById("tbody").querySelectorAll('input.selected');
