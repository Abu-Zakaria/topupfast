<template>
	<Layout name="WithdrawTransaction">
						...
						<div class="card-body">
					        ...
					        <div class="modal fade" id="modal_accept">
					            <div class="modal-dialog">
					                <div class="modal-content">
					                    <div class="modal-header">
					                        <h4 class="modal-title">Accept the transaction</h4>
					                    </div>
					                    <div class="modal-body">
					                        <div class="form-group">
	    ...
	    watch: {
	    	searchform: {
	    		handler: throttle(function() {
					...
					this.$inertia.replace(this.route('withdraw_transactions.index', Object.keys(query).length ? query : { remember: 'forget' }))
	    		}, 150),
	    		deep: true
	    	}
	    },
