				...
				<div class="card-content">
					<div class="card-body">
				        ...
				        <table class="table table-bordered table-sm table-condensed">
				            ...
				            <tr v-for="(row , index) in paymentmethods.data" :key="index">
				                <td>{{ index+1 }}</td>
				                <td>{{ row.name }}</td>
								<td>{{ row.number }}</td>
								<td><img :src="'paymentmethods/'+row.logo" alt="opps" style="height:50px;width:auto;"></td>
				                <td width="200">
				        ...
				        <pagination :links="paymentmethods.links"></pagination>
				                ...
				                <div class="modal-content">
				                    ...
				                    <div class="modal-body">
										...
										<div class="form-group">
				                            ...
				                            <input class="form-control"  :class="[errors.number ? 'is-invalid' : '']" required id="number" placeholder="Number" v-model="form.number"/>
				                             <span
						                          v-if="errors.number"
						                          class="invalid-feedback"
						                          role="alert"
