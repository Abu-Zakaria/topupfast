				...
				<div class="card-content">
					<div class="card-body">
				        ...
				        <table class="table table-bordered table-sm table-condensed">
				            ...
				            <tr v-for="(row , index) in brands.data" :key="index">
				                <td>{{ index+1 }}</td>
				                <td>{{ row.name }}</td>
								<td><img :src="'brands/'+row.logo" alt="opps" style="height:50px;width:auto;"></td>
				                <td width="200">
				        ...
				        <pagination :links="brands.links"></pagination>
